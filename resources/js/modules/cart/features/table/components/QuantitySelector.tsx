...
const SelectorView = ({ quantity, inputValue, onIncrease, onDecrease, onChange, onBlur }: QuantitySelectorViewProps) => {
    const buttonClass = 'flex h-full w-full items-center justify-center px-1.5 disabled:cursor-not-allowed';
    const iconClass = 'text-text-main h-[18px] w-[18px] lg:h-[24px] lg:w-[24px]';
    const wrapperClass = 'border-main flex h-[28px] w-fit items-center overflow-hidden rounded-lg border lg:h-[40px] lg:rounded-xl';
    const inputClass =
